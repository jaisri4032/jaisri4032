...
| :--- | :--- | :--- |
| **Learning** | 📚 Core Tech Up-skilling | Advanced React State Workflows (Redux)<br>• JavaScript Backend Workflows (Node.js)<br>• Generative AI Integration |
| **Building** | 🛠️ Active Development | Responsive Frontend Application Dashboards<br>• Structured SQL Database Architectures |
| **Exploring** | 🔍 Next-Gen Tech | Foundation Model Capabilities<br>• Intelligent Automation Workflows |
| **Open To** | 🤝 Next Steps | Technical Collaborations<br>• Graduate Software Roles |this is my profile you know my resu e and about projects so give like that
